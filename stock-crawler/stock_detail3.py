...
for k in h:
    ...
    while True:
        s = os.popen(
            "curl 'https://api.wantgoo.com/%E8%A1%8C%E5%8B%95%E7%89%88%E6%9C%AC_%E8%82%A1%E7%A5%A8/%E5%80%8B%E8%82%A1%E7%B7%9A%E5%9C%96/%E5%8D%B3%E6%99%82%E7%B7%9A%E5%9C%96%E8%B3%87%E6%96%99?StockNo="
            + k +
            "&type=2&days=5' -H 'Origin: https://www.wantgoo.com' -H 'Accept-Encoding: gzip, deflate, br' -H 'Accept-Language: en-US,en;q=0.9,zh-TW;q=0.8,zh;q=0.7' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/66.0.3359.117 Safari/537.36' -H 'Accept: */*' -H 'Referer: https://www.wantgoo.com/stock/00637l' -H 'Connection: keep-alive' --compressed"
        ).read()
        if len(s) > 0: break
